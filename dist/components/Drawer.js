...
const {
  ...
  "#drawerContainer": {
    transition: "padding-right, padding-left, margin-left, margin-right, width, flex",
...
export default class Drawer extends React.Component {
  constructor() {
    super();
    this.drawerLayout = /*#__PURE__*/React.createRef();
    this.state = {};
  }
  ...
  updateCSS() {
    ...
    isOpen ? document.body.classList.add("drawer-visible") : document.body.classList.remove("drawer-visible");
  ...
  render() {
    ...
    return mapClass( /*#__PURE__*/React.createElement("div", {
      ref: this.drawerLayout,
      className: `${isOpen ? "drawerLayout" : ""} ${left ? "left" : "right"}Drawer ${isOpen ? `${left ? "left" : "right"}DrawerVisible` : ""}`
    }, children));
  }
